...
void FocusNextWidget(UiState& ui, bool isTsconf = true);
void FocusPrevWidget(UiState& ui, bool isTsconf = true);

// Field navigation inside the active widget
void HandleArrowKey(IDebuggerBackend& be, UiState& ui, NavKey key, bool isTsconf = true);
...
bool HandleMouseClick(IDebuggerBackend& be, UiState& ui, int cellX, int cellY, bool isTsconf = true);
