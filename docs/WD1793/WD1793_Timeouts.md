...
| :------------------------------------ | :------------------------------------------------------------------- |:-------------------------------------------------------------------------|:----------------------------------------------------|:----------------------------------------------------|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **DRQ Service Timeout (Lost Data)**   | READ SECTOR, WRITE SECTOR, READ ADDRESS, READ TRACK, WRITE TRACK     | MFM: 32 µs <br/> FM: 64 µs                                               | MFM: 32 µs <br/> FM: 64 µs                          | MFM: 32 µs <br/> FM: 64 µs                          | MFM: ~112 T-states <br/> FM: ~224 T-states                           | **These absolute timeout values are solely determined by FDD transfer speed (one byte-time) and encoding (MFM/FM). Independent of FDC/CPU clocks.** MFM (250 Kbit/s = 32 µs/byte). FM (125 Kbit/s = 64 µs/byte). | Lost Data (Status Register bit 2 or S2). CPU must R/W Data Register within this fixed **ONE FDD byte-time** of DRQ. The FDC uses its clock to measure if this external deadline is missed. |
