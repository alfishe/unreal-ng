...
- **Existing tests:**
  - `moonsound_device_test.cpp`: `SuppressedFrame_RendersSilenceCoreKeepsRunning` (:789), `TTD_SaveNeutralAndRestoreExact_ReplaysIdenticalAudio` (:831), `TTD_RestoreHiFi_ConvergesAfterFilterWindow` (:895), `TTD_RoundTrip_*` (:1020), `Canary_*`.
