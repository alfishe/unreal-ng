...
| [`command-interface.md`](../../emulator/design/control-interfaces/command-interface.md) | Documented ScreenHQ feature |
...
See [Screen Rendering Pipeline](../../emulator/design/video/screen-rendering-pipeline.md)
