...
### Discovery
A proper `RecordingManager` exists ([see docs](../../emulator/design/recording/recording-system.md)) with:
...
### Required Action
> [!NOTE]
> This optimization requires a **new feature flag** and a full design/planning cycle per [feature-management.md](../../emulator/design/core/feature-management.md).
