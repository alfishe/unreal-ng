...
| `tech_support.sna` | 128K snapshot (131 103 bytes) taken in unreal-ng from the TAP below at the demo entry point: the BASIC loader's `RANDOMIZE USR 33155`, paused by an execution breakpoint at 33155 right after the last block loaded and **before** the player initialises the YM2203s (both chips at reset: FM muted, no keys). PC 0x8183, `#7FFD` = 0x10. Regenerated 2026-09-13; an earlier snapshot taken after chip init was discarded | same as the TAP | `ef5e0b80c54b41f18c0e63ba934cce56f48f8d4e3de5211a7c38618cd24961d3` |
