...
protected:
	...
	const uint8_t rlcf[0x100] = // for rlc r. may be for rlca (0x3B mask)
	{
	...
	const uint8_t rrcf[0x100] = // rrc r. may be for rlca (0x3B mask)
	{
	...
	uint8_t adcf[0x20000];

	// flags for sub and sbc
	uint8_t sbcf[0x20000];
