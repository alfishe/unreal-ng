...
typedef void(__cdecl *CallbackBankNames)(int i, char *Name);
typedef void (*CallbackStep)();
typedef int64_t(__cdecl *CallbackDelta)();
typedef void(__cdecl *CallbackSetLastT)();
