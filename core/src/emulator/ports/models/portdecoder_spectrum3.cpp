...
uint8_t PortDecoder_Spectrum3::DecodePortIn(uint16_t addr)
{
    uint8_t result = 0xFF;
...
void PortDecoder_Spectrum3::DecodePortOut(uint16_t addr, uint8_t value)
{
...
/// \param value
void PortDecoder_Spectrum3::Port_7FFD(uint8_t value)
{
...
bool PortDecoder_Spectrum3::IsPort_7FFD(uint16_t addr)
{
    //    ZX Spectrum 128 +2A/+2B/+3
    //    port: #7FFD
    ...
    static const uint16_t port_7FFD_mask        = 0b0100000000000000;
    static const uint16_t port_7FFD_mask_inv    = 0b1000000000000010;

    bool result = !(addr & port_7FFD_mask_inv) && (addr & port_7FFD_mask);

    return result;
}

bool PortDecoder_Spectrum3::IsPort_1FFD(uint16_t addr)
{
    //    ZX Spectrum +2A / +3
    //    port: #1FFD
...
/// \param value
void PortDecoder_Spectrum3::Port_1FFD(uint8_t value)
{
