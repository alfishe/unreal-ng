...
class Keyboard
{
    ...
    static constexpr KeyDescriptor keys[KEYS_COUNT] =
    {
        ...
        { ZXKEY_X,            0b0001'1111, 0b0001'1011, 0xFEFE, 0 },
        { ZXKEY_C,            0b0001'1111, 0b0001'0111, 0xFEFE, 0 },
        { ZXKEY_V,            0b0001'1111, 0b0000'1111, 0xFEFE, 0 },

        { ZXKEY_A,            0b0001'1111, 0b0001'1110, 0xFDFE, 1 },
        { ZXKEY_S,            0b0001'1111, 0b0001'1101, 0xFDFE, 1 },
        { ZXKEY_D,            0b0001'1111, 0b0001'1011, 0xFDFE, 1 },
        { ZXKEY_F,            0b0001'1111, 0b0001'0111, 0xFDFE, 1 },
        { ZXKEY_G,            0b0001'1111, 0b0000'1111, 0xFDFE, 1 },

        { ZXKEY_Q,            0b0001'1111, 0b0001'1110, 0xFBFE, 2 },
        { ZXKEY_W,            0b0001'1111, 0b0001'1101, 0xFBFE, 2 },
        { ZXKEY_E,            0b0001'1111, 0b0001'1011, 0xFBFE, 2 },
        { ZXKEY_R,            0b0001'1111, 0b0001'0111, 0xFBFE, 2 },
        { ZXKEY_T,            0b0001'1111, 0b0000'1111, 0xFBFE, 2 },

        { ZXKEY_1,            0b0001'1111, 0b0001'1110, 0xF7FE, 3 },
        { ZXKEY_2,            0b0001'1111, 0b0001'1101, 0xF7FE, 3 },
        { ZXKEY_3,            0b0001'1111, 0b0001'1011, 0xF7FE, 3 },
        { ZXKEY_4,            0b0001'1111, 0b0001'0111, 0xF7FE, 3 },
        { ZXKEY_5,            0b0001'1111, 0b0000'1111, 0xF7FE, 3 },

        { ZXKEY_0,            0b0001'1111, 0b0001'1110, 0xEFFE, 4 },
        { ZXKEY_9,            0b0001'1111, 0b0001'1101, 0xEFFE, 4 },
        { ZXKEY_8,            0b0001'1111, 0b0001'1011, 0xEFFE, 4 },
        { ZXKEY_7,            0b0001'1111, 0b0001'0111, 0xEFFE, 4 },
        { ZXKEY_6,            0b0001'1111, 0b0000'1111, 0xEFFE, 4 },

        { ZXKEY_P,            0b0001'1111, 0b0001'1110, 0xDFFE, 5 },
        { ZXKEY_O,            0b0001'1111, 0b0001'1101, 0xDFFE, 5 },
        { ZXKEY_I,            0b0001'1111, 0b0001'1011, 0xDFFE, 5 },
        { ZXKEY_U,            0b0001'1111, 0b0001'0111, 0xDFFE, 5 },
        { ZXKEY_Y,            0b0001'1111, 0b0000'1111, 0xDFFE, 5 },

        { ZXKEY_ENTER,        0b0001'1111, 0b0001'1110, 0xBFFE, 6 },
        { ZXKEY_L,            0b0001'1111, 0b0001'1101, 0xBFFE, 6 },
        { ZXKEY_K,            0b0001'1111, 0b0001'1011, 0xBFFE, 6 },
        { ZXKEY_J,            0b0001'1111, 0b0001'0111, 0xBFFE, 6 },
        { ZXKEY_H,            0b0001'1111, 0b0000'1111, 0xBFFE, 6 },

        { ZXKEY_SPACE,        0b0001'1111, 0b0001'1110, 0x7FFE, 7 },
        { ZXKEY_SYM_SHIFT,    0b0001'1111, 0b0001'1101, 0x7FFE, 7 },
        { ZXKEY_M,            0b0001'1111, 0b0001'1011, 0x7FFE, 7 },
        { ZXKEY_N,            0b0001'1111, 0b0001'0111, 0x7FFE, 7 },
...
public:
    ...
    void OnKey(char key, bool isPressed, bool shift, bool ctrl, bool alt);  // Translate host keyboard event to ZX-Spectrum
