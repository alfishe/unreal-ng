...
ZXKeyMap Keyboard::_zxKeyMap({
    ...
    {ZXKEY_C, Keyboard::_keys[3]},          {ZXKEY_V, Keyboard::_keys[4]},

    {ZXKEY_A, Keyboard::_keys[5]},          {ZXKEY_S, Keyboard::_keys[6]},          {ZXKEY_D, Keyboard::_keys[7]},
    {ZXKEY_F, Keyboard::_keys[8]},          {ZXKEY_G, Keyboard::_keys[9]},

    {ZXKEY_Q, Keyboard::_keys[10]},         {ZXKEY_W, Keyboard::_keys[11]},         {ZXKEY_E, Keyboard::_keys[12]},
    {ZXKEY_R, Keyboard::_keys[13]},         {ZXKEY_T, Keyboard::_keys[14]},

    {ZXKEY_1, Keyboard::_keys[15]},         {ZXKEY_2, Keyboard::_keys[16]},         {ZXKEY_3, Keyboard::_keys[17]},
    {ZXKEY_4, Keyboard::_keys[18]},         {ZXKEY_5, Keyboard::_keys[19]},

    {ZXKEY_0, Keyboard::_keys[20]},         {ZXKEY_9, Keyboard::_keys[21]},         {ZXKEY_8, Keyboard::_keys[22]},
    {ZXKEY_7, Keyboard::_keys[23]},         {ZXKEY_6, Keyboard::_keys[24]},

    {ZXKEY_P, Keyboard::_keys[25]},         {ZXKEY_O, Keyboard::_keys[26]},         {ZXKEY_I, Keyboard::_keys[27]},
    {ZXKEY_U, Keyboard::_keys[28]},         {ZXKEY_Y, Keyboard::_keys[29]},

    {ZXKEY_ENTER, Keyboard::_keys[30]},     {ZXKEY_L, Keyboard::_keys[31]},         {ZXKEY_K, Keyboard::_keys[32]},
    {ZXKEY_J, Keyboard::_keys[33]},         {ZXKEY_H, Keyboard::_keys[34]},

    {ZXKEY_SPACE, Keyboard::_keys[35]},     {ZXKEY_SYM_SHIFT, Keyboard::_keys[36]}, {ZXKEY_M, Keyboard::_keys[37]},
    {ZXKEY_N, Keyboard::_keys[38]},         {ZXKEY_B, Keyboard::_keys[39]},
});
...
uint8_t Keyboard::increaseKeyPressCounter(ZXKeysEnum key)
{
    ...
    if (isExtendedKey(key))
    {
        throw std::logic_error(
            "Only base keys can be processed. Split extended key to combination of base key + modifier key");
    }
...
void Keyboard::OnKeyPressed([[maybe_unused]] int id, Message* message)
{
    ...
    {
        // Check if this event is for our specific emulator instance
        if (!event->targetEmulatorId.empty())
        {
            std::string ourEmulatorId = _context->pEmulator->GetUUID();
            if (event->targetEmulatorId != ourEmulatorId)
            {
