/// @file ttdwritejournal.cpp
/// @brief TTD write journal — implementation.
///
/// Per parent TDD §9.3. See ttdwritejournal.h for the threading model and
/// design rationale.
...
{
    (void)asyncAlloc;  // nothing to offload: memory is committed lazily (LazyRing)
