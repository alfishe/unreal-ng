...
// OF_JUMP - Instruction is a jump (JP, JR)
// OF_CALL - Instruction is a call (CALL)
...
OpCode Z80Disassembler::noprefixOpcodes[256] =
{
    ...
    { OF_INDIRECT,   7, 0, 0, "ld (bc),a" },                        // 0x02
    ...
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 17, 10, "call z,:2" },  // 0xCC
    { OF_CALL | OF_MWORD, 17, 0, 0, "call :2" },                    // 0xCD
    ...
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 17, 10, "call nc,:2" }, // 0xD4
    ...
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 17, 10, "call c,:2" },  // 0xDC
    ...
    { OF_INDIRECT, 19, 0, 0, "ex (sp),hl" },                        // 0xE3
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 17, 10, "call po,:2" }, // 0xE4
    ...
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 17, 10, "call m,:2" },  // 0xFC
...
OpCode Z80Disassembler::cbOpcodes[256]
{
    ...
    { OF_INDIRECT, 15, 0, 0, "rlc (hl)" },                  // 0x06
    ...
    { OF_INDIRECT, 15, 0, 0, "rrc (hl)" },                  // 0x0E
    ...
    { OF_INDIRECT, 15, 0, 0, "sla (hl)" },                  // 0x26
    ...
    { OF_INDIRECT, 15, 0, 0, "sra (hl)" },                  // 0x2E
    ...
    { OF_INDIRECT, 15, 0, 0, "sll (hl)" },                  // 0x36
    ...
    { OF_INDIRECT, 15, 0, 0, "srl (hl)" },                  // 0x3E
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 0,(hl)" },                // 0x46
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 1,(hl)" },                // 0x4E
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 2,(hl)" },                // 0x56
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 3,(hl)" },                // 0x5E
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 4,(hl)" },                // 0x66
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 5,(hl)" },                // 0x6E
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 6,(hl)" },                // 0x76
    ...
    { OF_INDIRECT, 12, 0, 0, "bit 7,(hl)" },                // 0x7E
    ...
    { OF_INDIRECT, 15, 0, 0, "res 0,(hl)" },                // 0x86
    ...
    { OF_INDIRECT, 15, 0, 0, "res 1,(hl)" },                // 0x8E
    ...
    { OF_INDIRECT, 15, 0, 0, "res 2,(hl)" },                // 0x96
    ...
    { OF_INDIRECT, 15, 0, 0, "res 3,(hl)" },                // 0x9E
    ...
    { OF_INDIRECT, 15, 0, 0, "res 4,(hl)" },                // 0xA6
    ...
    { OF_INDIRECT, 15, 0, 0, "res 5,(hl)" },                // 0xAE
    ...
    { OF_INDIRECT, 15, 0, 0, "res 6,(hl)" },                // 0xB6
    ...
    { OF_INDIRECT, 15, 0, 0, "res 7,(hl)" },                // 0xBE
    ...
    { OF_INDIRECT, 15, 0, 0, "set 0,(hl)" },                // 0xC6
    ...
    { OF_INDIRECT, 15, 0, 0, "set 1,(hl)" },                // 0xCE
    ...
    { OF_INDIRECT, 15, 0, 0, "set 2,(hl)" },                // 0xD6
    ...
    { OF_INDIRECT, 15, 0, 0, "set 3,(hl)" },                // 0xDE
    ...
    { OF_INDIRECT, 15, 0, 0, "set 4,(hl)" },                // 0xE6
    ...
    { OF_INDIRECT, 15, 0, 0, "set 5,(hl)" },                // 0xEE
    ...
    { OF_INDIRECT, 15, 0, 0, "set 6,(hl)" },                // 0xF6
    ...
    { OF_INDIRECT, 15, 0, 0, "set 7,(hl)" },                // 0xFE
...
OpCode Z80Disassembler::ddOpcodes[256]
{
    ...
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 21, 14, "call z,:2" },   // 0xCC
    { OF_CALL | OF_MWORD, 21, 0, 0, "call :2" },                     // 0xCD
    ...
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 21, 14, "call nc,:2" },  // 0xD4
    ...
    { OF_CALL | OF_CONDITION |  OF_MWORD, 0, 21, 14, "call c,:2" },  // 0xDC
    ...
    { OF_CALL | OF_CONDITION | OF_MWORD,  0, 21, 14, "call p,:2" },  // 0xF4
...
OpCode Z80Disassembler::edOpcodes[256] =
{
    ...
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "ldir" },            // 0xB0
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "cpir" },            // 0xB1
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "inir" },            // 0xB2
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "otir" },            // 0xB3
    { OF_NONE,  8, 0, 0, "nop *" },                         // 0xB4
    { OF_NONE,  8, 0, 0, "nop *" },                         // 0xB5
    { OF_NONE,  8, 0, 0, "nop *" },                         // 0xB6
    { OF_NONE,  8, 0, 0, "nop *" },                         // 0xB7
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "lddr" },            // 0xB8
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "cpdr" },            // 0xB9
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "indr" },            // 0xBA
    { OF_BLOCK | OF_VAR_T,  0, 16, 21, "otdr" },            // 0xBB
...
OpCode Z80Disassembler::fdOpcodes[256]
{
    ...
    { OF_RST, 15, 0, 0, "rst #20" },                                 // 0xE7
    { OF_RET | OF_CONDITION, 0, 15, 9, "ret pe" },                   // 0xE8
    { OF_JUMP | OF_INDIRECT, 8, 0, 0, "jp (iy)" },                   // 0xE9
    { OF_JUMP | OF_CONDITION | OF_MWORD,  0, 14, 14, "jp pe,:2" },   // 0xEA
    { OF_NONE,  4, 0, 0, "ex de,hl" },                               // 0xEB
    { OF_CALL | OF_CONDITION | OF_MWORD, 0, 17, 10, "call pe,:2" },  // 0xEC
    { OF_PREFIX,  4, 0, 0, "#ED" },                                  // 0xED - Prefix
...
bool Z80Disassembler::shouldStepOver(const std::vector<uint8_t>& buffer)
{
    ...
    // with breakpoint set to next instruction. JP / JR jumps require no breakpoints
    // and can be handled as simple StepIn
    if ((flags & OF_CALL) || (flags & OF_RST) || (flags & OF_BLOCK) || (flags & OF_DJNZ))
    {
        result = true;
    }
