...
/*
 * unreal-ng local patch (see README.md in this directory):
 * 1. Renamed z80ex.c -> z80ex.cpp and compiled as C++ (blip_buf precedent:
 *    the core project builds CXX only). The only C-vs-C++ difference that
 *    matters here is the explicit malloc cast below, which upstream already
 *    has.
 * 2. The version macros normally injected via -D from the upstream Makefile
 *    are defined here with #ifndef guards so both build paths work.
 */
...
#ifndef Z80EX_API_REVISION
#define Z80EX_API_REVISION 1
#endif
#ifndef Z80EX_VERSION_MAJOR
#define Z80EX_VERSION_MAJOR 0
#endif
#ifndef Z80EX_VERSION_MINOR
#define Z80EX_VERSION_MINOR 16
#endif
#ifndef Z80EX_RELEASE_TYPE
#define Z80EX_RELEASE_TYPE ""
#endif
#ifndef Z80EX_VERSION_STR
#define Z80EX_VERSION_STR "0.16"
#endif
