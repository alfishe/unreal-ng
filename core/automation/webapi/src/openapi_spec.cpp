                                 ...
                                 std::function<void(const HttpResponsePtr&)>&& callback) const
{
    ...
    Json::Value tagBatch;
    tagBatch["name"] = "Batch Execution";
    tagBatch["description"] = "Parallel batch command execution across emulators";
    tags.append(tagBatch);
...
#include "openapi/openapi_batch.inc"
